...
class bs4Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        // New
        if ($depth === 0) {
            $atts['class'] = 'nav-link d-flex align-items-center gradient-animation';
        }
        ...
        //
            ...
            $menu_item_featured_image = get_field( 'navmenu_icon', $item->ID );
            $item_output .= '<a'. $attributes .'>';

            $item_output .= '<img class="pr-2" src="'. $menu_item_featured_image .'">';
